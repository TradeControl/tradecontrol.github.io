...
Time is modelled in [App.tbYear](https://github.com/TradeControl/sqlnode/blob/HEAD/src/tcNodeDb4/App/Tables/tbYear.sql) and [App.tbYearPeriod](https://github.com/TradeControl/sqlnode/blob/HEAD/src/tcNodeDb4/App/Tables/tbYearPeriod.sql), which can start at any month. The periods are used for the calculation of profit and loss, capital, vat and corporation tax. I also use them for presenting the Invoice Register, Cash Statements, Job Profit and BI reporting.
