...
permalink: /cash/category-tree-getting-around
---
...
- User Guide (why/what/how, business-focused): [User Guide — Category Tree](/cash/category-tree-userguide)
- Technical Guide (mechanics, roles, handlers, shortcuts): [Technical Guide — Category Tree](/cash/category-tree-technical)
...
- Map Disconnected categories:
  ...
  - See: [User Guide — How: Configure step by step](/cash/category-tree-userguide#how-configure-step-by-step)
- Create core Totals:
...
- Define Expressions:
  ...
  - See: [User Guide — What: Categories, Cash Codes, Totals, Expressions](/cash/category-tree-userguide#what-categories-cash-codes-totals-expressions)
...
For keyboard and drag/drop rules (admin): see [Technical Guide — Reorder mechanics](/cash/category-tree-technical#6-reorder-mechanics).
...
- Business-first overview and step-by-step configuration:
  - [Category Tree — User Guide](/cash/category-tree-userguide)
- Detailed mechanics (roles, handlers, antiforgery, shortcuts, JSON responses):
  - [Category Tree — Technical Guide](/cash/category-tree-technical)