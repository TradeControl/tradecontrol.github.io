...
- ![category-tree-node-types](images/category-tree-node-types.png)
...
- Desktop details pane with admin actions:
  - ![category-tree-details-admin](images/category-tree-details-admin.png)
- Mobile action bar showing admin buttons:
  - ![category-tree-mobile-actionbar](images/category-tree-mobile-actionbar.png)
...
Screenshots:
- Annotated desktop with selection via query params:
  - ![category-tree-selection](images/category-tree-selection.png)
- Embedded details pane showing cancel:
  - ![category-tree-embedded-cancel](images/category-tree-embedded-cancel.png)
...
- Cash Code create
  ...
  - Screenshot: ![create-cash-code](images/create-cash-code.png)
...
- Total vs Category create/edit
  ...
  - Screenshot: ![edit-category-total](images/edit-category-total.png)
...
- Expression create/edit
  ...
  - Screenshot: ![create-expression](images/create-expression.png)
...
- Root setting (Set Profit Root / Set VAT Root)
  ...
  - Screenshot: ![set-primary-root](images/set-primary-root.png)
...
- Normalization
  ...
  - Screenshot: ![drag-drop-reorder](images/drag-drop-reorder.png)
...
- Server behavior
  ...
  - Screenshot: ![toggle-enabled](images/toggle-enabled.png)
...
- Screenshot: ![expression-details](images/expression-details.png)
...
- Screenshot: ![mobile-action-bar](images/mobile-action-bar.png)
...
- Fallbacks
  ...
  - Screenshot: ![embedded-injection](images/embedded-injection.png)
...
- Screenshot: ![disconnected-subtree](images/disconnected-subtree.png)
...
- Screenshot: ![root-and-primary](images/root-and-primary.png)


## 13. Error & fallback

The UI favors smooth in-place updates, but degrades gracefully when something goes wrong.
...
- Screenshot: ![error-fallback](images/error-fallback.png)
...
- Screenshot: ![styling-icons](images/styling-icons.png)
...
- Screenshot: ![security-antiforgery](images/security-antiforgery.png)
...
Screenshot: ![persistence](images/persistence.png)
...
Screenshot: ![performance](images/performance.png)
...
Screenshot: ![glossary](images/glossary.png)
