...
The installation builds upon the [Network tutorial]({{ site.url }}/tutorials/network) to show how supply chains can be financed using bitcoin. 
...
Now the wallets in the supply-chain have been set up, you can [work through the tutorial]({{ site.url }}/tutorials/bitcoin).
